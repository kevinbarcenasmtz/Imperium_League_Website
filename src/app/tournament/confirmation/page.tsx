  ...
  return (
    <Container>
      <div className="w-full max-w-3xl mx-auto px-4 py-6 sm:py-8 lg:py-12">
        ...
        <div className="bg-white dark:bg-gray-800 shadow-lg rounded-lg p-4 sm:p-6 lg:p-8 mb-6 sm:mb-8">
          <h2 className="text-lg sm:text-xl lg:text-2xl font-semibold mb-4 sm:mb-6 dark:text-white">
            Registration Details
          </h2>
          <div className="space-y-3 sm:space-y-4">
            <div>
              <p className="text-sm sm:text-base text-gray-600 dark:text-gray-400">Team Name</p>
              <p className="text-base sm:text-lg font-medium dark:text-white">{teamName}</p>
            </div>
            <div>
              <p className="text-sm sm:text-base text-gray-600 dark:text-gray-400">Team Captain</p>
              <p className="text-base sm:text-lg font-medium dark:text-white">{captain}</p>
            </div>
          </div>
        </div>
