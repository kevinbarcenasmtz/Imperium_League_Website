      ...
      {/* <Container>
        <div className="py-10">
          <h2 className="text-3xl font-bold text-center text-gray-800 dark:text-white">
            Why Join Empire Football League?
          </h2>
        ...
        {/* <div className="py-10">
          ...
          <div className="mt-10 space-y-6">
            <div className="flex justify-between p-4 bg-gray-100 rounded-md dark:bg-gray-700">
              <span className="font-medium text-gray-800 dark:text-white">
                Team A vs Team B
              </span>
              <span className="text-gray-500 dark:text-gray-300">Wed, Nov 22, 7:00 PM</span>
            </div>
            <div className="flex justify-between p-4 bg-gray-100 rounded-md dark:bg-gray-700">
              <span className="font-medium text-gray-800 dark:text-white">
                Team C vs Team D
              </span>
              <span className="text-gray-500 dark:text-gray-300">Thu, Nov 23, 8:30 PM</span>
            </div>
            <div className="flex justify-between p-4 bg-gray-100 rounded-md dark:bg-gray-700">
              <span className="font-medium text-gray-800 dark:text-white">
                Team E vs Team F
              </span>
              <span className="text-gray-500 dark:text-gray-300">Fri, Nov 24, 6:00 PM</span>
            </div>
          </div>
        </div>
